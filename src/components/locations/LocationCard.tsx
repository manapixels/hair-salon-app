      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <a
            ...
            className="inline-flex items-center text-xs font-medium text-[var(--accent-11)] hover:text-[var(--accent-9)] transition-colors font-sans uppercase tracking-wider"
          >
            Get Directions
            <svg
