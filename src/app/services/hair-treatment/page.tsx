...
export default async function HairTreatmentPage() {
  ...
  const serviceContent = getServiceContent('hair-treatment');
  ...
  return (
    <div className="bg-[#FDFCF8] min-h-screen">
      ...
      <div className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
        <Image
          src={service.imageUrl || '/background-images/hair-treatment.png'}
          alt={service.name}
          fill
...
export async function generateMetadata() {
  return {
    title: 'Scalp Treatment | Signature Trims',
    description:
      'Comprehensive scalp care service designed to cleanse, balance, and nourish your scalp for optimal hair health. Address concerns like oiliness, dryness, dandruff, and promote healthy hair growth.',
  };
}
